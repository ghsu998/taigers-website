  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-gray-800">
      ...
      <section id="about" className="max-w-6xl mx-auto text-center py-20 px-6">
        <h2 className="text-3xl font-semibold text-[#1F3A93]">About Taigers</h2>
      ...
      <section id="services" className="max-w-6xl mx-auto py-20">
        <h2 className="text-3xl font-semibold text-center text-[#1F3A93] mb-12">Our Services</h2>
      ...
      <section id="contact" className="max-w-4xl mx-auto text-center py-20 px-6">
        <h2 className="text-3xl font-semibold text-[#1F3A93]">Get In Touch</h2>
        ...
        <a href="mailto:info@taigers.com" className="mt-6 inline-block bg-[#FF7A00] text-white font-bold text-lg px-6 py-3 rounded-full hover:bg-orange-600">
          Email Us
        </a>
      </section>
